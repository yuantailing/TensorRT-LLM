...
def make_balanced_routing_method(
    ...
    def balanced_routing_method(router_logits):
        ...
        assert moe_module._routing_results_replaced_at is None
...
def make_balanced_run_moe(
    ...
    def balanced_run_moe(
        ...
        logger.warning_once(
            'Specifying routing results of "TRTLLM" MoE backend in TEP cases leads to different execution path around'
            " the topk kernel",
